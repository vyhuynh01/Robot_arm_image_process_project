...
RobotArm_MoPhong_3ef711a9_1_assertData [ ] ; extern const NeZCData
RobotArm_MoPhong_3ef711a9_1_ZCData [ ] ; void
RobotArm_MoPhong_3ef711a9_1_computeRuntimeParameters ( const double *
runtimeRootVariables , double * runtimeParameters ) ; void
RobotArm_MoPhong_3ef711a9_1_validateRuntimeParameters ( const double *
...
; void RobotArm_MoPhong_3ef711a9_1_computeSimRuntimeDerivedValues ( const
double * runtimeParameters , RuntimeDerivedValuesBundle *
runtimeDerivedValuesBundle ) ; void
RobotArm_MoPhong_3ef711a9_1_initializeGeometries ( const
RuntimeDerivedValuesBundle * runtimeDerivedValuesBundle ) ; PmfMessageId
RobotArm_MoPhong_3ef711a9_1_compDerivs ( const RuntimeDerivedValuesBundle * ,
...
const double * , const double * , const double * , const double * , double *
, double * , NeuDiagnosticManager * neDiagMgr ) ; PmfMessageId
RobotArm_MoPhong_3ef711a9_1_checkDynamics ( const RuntimeDerivedValuesBundle
* , const double * , const double * , const double * , const double * , const
double * , const int * , double * , NeuDiagnosticManager * neDiagMgr ) ;
PmfMessageId RobotArm_MoPhong_3ef711a9_1_compOutputsDyn ( const
RuntimeDerivedValuesBundle * , const int * , const double * , const int * ,
const double * , const double * , const double * , const double * , double *
, double * , int * , double * , NeuDiagnosticManager * neDiagMgr ) ;
PmfMessageId RobotArm_MoPhong_3ef711a9_1_compOutputsKin ( const
RuntimeDerivedValuesBundle * , const double * , const int * , const double *
, const double * , const double * , const double * , double * ,
NeuDiagnosticManager * neDiagMgr ) ; PmfMessageId
RobotArm_MoPhong_3ef711a9_1_compOutputs ( const RuntimeDerivedValuesBundle *
, const double * , const int * , const double * , const double * , const
double * , const double * , double * , NeuDiagnosticManager * neDiagMgr ) ;
PmfMessageId RobotArm_MoPhong_3ef711a9_1_computeAsmModeVector ( const double
* , const double * , const double * , int * , double * , NeuDiagnosticManager
* neDiagMgr ) ; PmfMessageId RobotArm_MoPhong_3ef711a9_1_computeSimModeVector
( const double * , const double * , const double * , int * , double * ,
NeuDiagnosticManager * neDiagMgr ) ; PmfMessageId
RobotArm_MoPhong_3ef711a9_1_computeZeroCrossings ( const
RuntimeDerivedValuesBundle * , const double * , const double * , const double
* , const double * , const double * , double * , double * ,
NeuDiagnosticManager * neDiagMgr ) ; PmfMessageId
RobotArm_MoPhong_3ef711a9_1_recordLog ( const RuntimeDerivedValuesBundle * ,
const int * , const double * , const int * , const double * , const double *
...
; void RobotArm_MoPhong_3ef711a9_1_resetAsmStateVector ( const void * mech ,
double * stateVector ) ; void RobotArm_MoPhong_3ef711a9_1_resetSimStateVector
( const void * mech , double * stateVector ) ; void
RobotArm_MoPhong_3ef711a9_1_initializeTrackedAngleState ( const void * mech ,
...
stateVector ) ; void RobotArm_MoPhong_3ef711a9_1_adjustPosition ( const void
...
stateVector ) ; void RobotArm_MoPhong_3ef711a9_1_computePosDofBlendMatrix (
...
error ) ; size_t RobotArm_MoPhong_3ef711a9_1_computeAssemblyJacobian ( const
...
) ; size_t RobotArm_MoPhong_3ef711a9_1_computeFullAssemblyJacobian ( const
void * mech , const RuntimeDerivedValuesBundle * runtimeDerivedValuesBundle ,
const double * stateVector , const int * modeVector , const double *
motionData , double * J ) ; boolean_T
RobotArm_MoPhong_3ef711a9_1_isInKinematicSingularity ( const void * mech ,
...
RobotArm_MoPhong_3ef711a9_1_convertStateVector ( const void * asmMech , const
...
double * solverStateVector , const double * u , const double * uDot , const
...
modeVector ) ; boolean_T RobotArm_MoPhong_3ef711a9_1_isVelocityViolation (
...
void * neDiagMgr ) ; void RobotArm_MoPhong_3ef711a9_1_computeConstraintError
( const void * mech , const RuntimeDerivedValuesBundle *
runtimeDerivedValuesBundle , const double * stateVector , const int *
modeVector , double * error ) ; void
RobotArm_MoPhong_3ef711a9_1_resetModeVector ( const void * mech , int *
...
neDiagMgr ) ; void RobotArm_MoPhong_3ef711a9_1_onModeChangedCutJoints ( const
void * mech , const int * prevModeVector , const int * modeVector , double *
stateVector ) ; PmfMessageId RobotArm_MoPhong_3ef711a9_1_assemble ( const
...
return ; RobotArm_MoPhong_3ef711a9_1_computeRuntimeParameters (
runtimeRootVariables , smData -> mRuntimeParameterScalars . mX ) ;
RobotArm_MoPhong_3ef711a9_1_computeAsmRuntimeDerivedValues ( smData ->
mRuntimeParameterScalars . mX , & dae -> mPrivateData ->
mAsmRuntimeDerivedValuesBundle ) ;
RobotArm_MoPhong_3ef711a9_1_computeSimRuntimeDerivedValues ( smData ->
mRuntimeParameterScalars . mX , & dae -> mPrivateData ->
mSimRuntimeDerivedValuesBundle ) ;
RobotArm_MoPhong_3ef711a9_1_initializeGeometries ( & smData ->
mSimRuntimeDerivedValuesBundle ) ;
...
; RobotArm_MoPhong_3ef711a9_1_validateRuntimeParameters ( runtimeParams ,
...
RobotArm_MoPhong_3ef711a9_1_compDerivs ( & smData ->
...
RobotArm_MoPhong_3ef711a9_1_numJacPerturbLoBounds ( & smData ->
mSimRuntimeDerivedValuesBundle , smData -> mSimulationDelegate .
mRunTimeEnabledEquations . mValues , systemInput -> mX . mX , systemInput ->
mM . mX , systemInput -> mU . mX , systemInput -> mU . mX + 3 , systemInput
...
neDiagMgr ) { const NeDaePrivateData * smData = dae -> mPrivateData ;
PmfMessageId errorId = NULL ; double errorResult = 0.0 ; errorId =
RobotArm_MoPhong_3ef711a9_1_numJacPerturbHiBounds ( & smData ->
mSimRuntimeDerivedValuesBundle , smData -> mSimulationDelegate .
mRunTimeEnabledEquations . mValues , systemInput -> mX . mX , systemInput ->
mM . mX , systemInput -> mU . mX , systemInput -> mU . mX + 3 , systemInput
...
errorId = RobotArm_MoPhong_3ef711a9_1_computeSimModeVector ( systemInput ->
mU . mX , systemInput -> mU . mX + 3 , systemInput -> mV . mX + 3 ,
...
errorResult = 0.0 ; return RobotArm_MoPhong_3ef711a9_1_computeZeroCrossings (
...
RobotArm_MoPhong_3ef711a9_1_constructStateVector ( NULL , systemInput -> mX .
mX , systemInput -> mU . mX , systemInput -> mU . mX + 3 , systemInput -> mD
. mX , fullStateVector ) ; errorId = RobotArm_MoPhong_3ef711a9_1_recordLog (
...
RobotArm_MoPhong_3ef711a9_1_checkDynamics ( & smData ->
...
RobotArm_MoPhong_3ef711a9_1_computeSimModeVector ( systemInput -> mU . mX ,
...
size_t numTargets = 12 ; unsigned int asmStatus = 0 ; double *
...
RobotArm_MoPhong_3ef711a9_1_computeAsmModeVector ( systemInput -> mU . mX ,
...
#if 0
RobotArm_MoPhong_3ef711a9_1_checkTargets ( & smData ->
...
mStateVectorSize = 0 ; smData -> mFullStateVectorSize = 6 ; smData ->
...
; const int32_T * stateVectorMap = NULL ; const CTarget targets [ 12 ] = { {
0 , 47 , 0 , false , 0 , 1 , "deg" , false , true , +
1.000000000000000000e+00 , false , 1 , { + 2.005874847875119826e+00 , +
0.000000000000000000e+00 , + 0.000000000000000000e+00 , +
0.000000000000000000e+00 } , { + 0.000000000000000000e+00 } } , { 0 , 47 , 0
, false , 0 , 0 , "1" , true , true , + 1.000000000000000000e+00 , false , 1
, { + 0.000000000000000000e+00 , + 0.000000000000000000e+00 , +
0.000000000000000000e+00 , + 0.000000000000000000e+00 } , { +
0.000000000000000000e+00 } } , { 0 , 48 , 0 , false , 0 , 1 , "deg" , false ,
true , + 1.000000000000000000e+00 , false , 1 , { - 2.268928027592637342e+00
, + 0.000000000000000000e+00 , + 0.000000000000000000e+00 , +
0.000000000000000000e+00 } , { + 0.000000000000000000e+00 } } , { 0 , 48 , 0
, false , 0 , 0 , "1" , true , true , + 1.000000000000000000e+00 , false , 1
, { + 0.000000000000000000e+00 , + 0.000000000000000000e+00 , +
0.000000000000000000e+00 , + 0.000000000000000000e+00 } , { +
0.000000000000000000e+00 } } , { 0 , 49 , 0 , false , 0 , 1 , "deg" , false ,
true , + 1.000000000000000000e+00 , false , 1 , { - 1.570796326794896336e+00
, + 0.000000000000000000e+00 , + 0.000000000000000000e+00 , +
0.000000000000000000e+00 } , { + 0.000000000000000000e+00 } } , { 0 , 49 , 0
, false , 0 , 0 , "1" , true , true , + 1.000000000000000000e+00 , false , 1
, { + 0.000000000000000000e+00 , + 0.000000000000000000e+00 , +
0.000000000000000000e+00 , + 0.000000000000000000e+00 } , { +
0.000000000000000000e+00 } } , { 0 , 49 , 0 , false , 0 , 3 , "" , false ,
...
, { + 0.000000000000000000e+00 , + 0.000000000000000000e+00 , +
0.000000000000000000e+00 , + 0.000000000000000000e+00 } , { +
0.000000000000000000e+00 } } , { 0 , 48 , 0 , false , 0 , 3 , "" , false ,
false , + 1.000000000000000000e+00 , false , 1 , { + 0.000000000000000000e+00
, + 0.000000000000000000e+00 , + 0.000000000000000000e+00 , +
0.000000000000000000e+00 } , { + 0.000000000000000000e+00 } } , { 0 , 48 , 0
, false , 0 , 3 , "" , true , false , + 1.000000000000000000e+00 , false , 1
, { + 0.000000000000000000e+00 , + 0.000000000000000000e+00 , +
0.000000000000000000e+00 , + 0.000000000000000000e+00 } , { +
0.000000000000000000e+00 } } , { 0 , 47 , 0 , false , 0 , 3 , "" , false ,
false , + 1.000000000000000000e+00 , false , 1 , { + 0.000000000000000000e+00
, + 0.000000000000000000e+00 , + 0.000000000000000000e+00 , +
0.000000000000000000e+00 } , { + 0.000000000000000000e+00 } } , { 0 , 47 , 0
, false , 0 , 3 , "" , true , false , + 1.000000000000000000e+00 , false , 1
...
mAssemblyFullStateVector , 6 , alloc ) ; checkMemAllocStatus ( status ) ;
status = pm_create_real_vector_fields ( & smData ->
mSimulationFullStateVector , 6 , alloc ) ; checkMemAllocStatus ( status ) ;
...
RobotArm_MoPhong_3ef711a9_1_assertData ; size_t i ; PM_ALLOCATE_ARRAY (
...
RobotArm_MoPhong_3ef711a9_1_ZCData ; size_t i ; PM_ALLOCATE_ARRAY ( smData ->
...
) { const char * inputPortPaths [ 3 ] = { "Revolute.qi" , "Revolute1.qi" ,
"Revolute2.qi" } ; const char * inputUnits [ 3 ] = { "rad" , "rad" , "rad" }
; const SizePair inputDimensions [ 3 ] = { { 1 , 1 } , { 1 , 1 } , { 1 , 1 }
} ; const char * * outputPortPaths = NULL ; const char * * outputUnits = NULL
; const SizePair * outputDimensions = NULL ; initIoInfoHelper ( 3 ,
...
) { const int32_T numInputDerivs [ 3 ] = { 2 , 2 , 2 } ; PmAllocator * alloc
...
jointToStageIdx [ 3 ] = { { 47 , 2 } , { 48 , 1 } , { 49 , 0 } } ; const
...
const size_t * equationsPerConstraint = NULL ; const int32_T *
hasAllVelocityDisabledEquations = NULL ; const int32_T *
runtimeEnabledEquations = NULL ; const size_t dofToVelSlot [ 3 ] = { 1 , 3 ,
5 } ; const size_t * constraintDofs = NULL ; const size_t
...
( & scratchpad -> mPosRequired , 3 ) ; sm_core_SmBoundedSet_create ( &
scratchpad -> mPosDesired , 3 ) ; sm_core_SmBoundedSet_create ( & scratchpad
-> mPosSuggested , 3 ) ; sm_core_SmBoundedSet_create ( & scratchpad ->
mPosFree , 3 ) ; sm_core_SmBoundedSet_create ( & scratchpad ->
mPosNonRequired , 3 ) ; sm_core_SmBoundedSet_create ( & scratchpad ->
mPosSuggAndFree , 3 ) ; sm_core_SmBoundedSet_create ( & scratchpad ->
mVelRequired , 3 ) ; sm_core_SmBoundedSet_create ( & scratchpad ->
mVelDesired , 3 ) ; sm_core_SmBoundedSet_create ( & scratchpad ->
mVelSuggested , 3 ) ; sm_core_SmBoundedSet_create ( & scratchpad -> mVelFree
, 3 ) ; sm_core_SmBoundedSet_create ( & scratchpad -> mVelNonRequired , 3 ) ;
...
scratchpad -> mInitialState , 6 , 0.0 ) ; sm_core_SmRealVector_create ( &
scratchpad -> mStartState , 6 , 0.0 ) ; sm_core_SmRealVector_create ( &
scratchpad -> mTestState , 6 , 0.0 ) ; sm_core_SmRealVector_create ( &
scratchpad -> mFullStateVector , 6 , 0.0 ) ; sm_core_SmIntVector_create ( &
...
) ; delegate -> mSetTargets = RobotArm_MoPhong_3ef711a9_1_setTargets ;
delegate -> mResetStateVector =
RobotArm_MoPhong_3ef711a9_1_resetAsmStateVector ; delegate ->
mInitializeTrackedAngleState =
RobotArm_MoPhong_3ef711a9_1_initializeTrackedAngleState ; delegate ->
mComputeDiscreteState = RobotArm_MoPhong_3ef711a9_1_computeDiscreteState ;
delegate -> mAdjustPosition = RobotArm_MoPhong_3ef711a9_1_adjustPosition ;
delegate -> mPerturbJointPrimitiveState =
RobotArm_MoPhong_3ef711a9_1_perturbAsmJointPrimitiveState ; delegate ->
mPerturbFlexibleBodyState = NULL ; delegate -> mComputePosDofBlendMatrix =
RobotArm_MoPhong_3ef711a9_1_computePosDofBlendMatrix ; delegate ->
mComputeVelDofBlendMatrix =
RobotArm_MoPhong_3ef711a9_1_computeVelDofBlendMatrix ; delegate ->
mProjectPartiallyTargetedPos =
RobotArm_MoPhong_3ef711a9_1_projectPartiallyTargetedPos ; delegate ->
mPropagateMotion = RobotArm_MoPhong_3ef711a9_1_propagateMotion ; delegate ->
mComputeAssemblyError = RobotArm_MoPhong_3ef711a9_1_computeAssemblyError ;
delegate -> mComputeAssemblyJacobian =
RobotArm_MoPhong_3ef711a9_1_computeAssemblyJacobian ; delegate ->
mComputeFullAssemblyJacobian =
RobotArm_MoPhong_3ef711a9_1_computeFullAssemblyJacobian ; delegate ->
mIsInKinematicSingularity =
RobotArm_MoPhong_3ef711a9_1_isInKinematicSingularity ; delegate ->
mConvertStateVector = RobotArm_MoPhong_3ef711a9_1_convertStateVector ;
...
= NULL ; const SmSizePair jointToStageIdx [ 3 ] = { { 47 , 2 } , { 48 , 1 } ,
{ 49 , 0 } } ; const size_t primitiveIndices [ 3 + 1 ] = { 0 , 1 , 2 , 3 } ;
...
, 2 , 4 } ; const size_t * equationsPerConstraint = NULL ; const int32_T *
hasAllVelocityDisabledEquations = NULL ; const int32_T *
runtimeEnabledEquations = NULL ; const size_t dofToVelSlot [ 3 ] = { 1 , 3 ,
5 } ; const size_t * constraintDofs = NULL ; const size_t
constraintDofOffsets [ 0 + 1 ] = { 0 } ; const size_t Jm = 0 ; const size_t
...
RobotArm_MoPhong_3ef711a9_1_resetSimStateVector ; delegate ->
...
RobotArm_MoPhong_3ef711a9_1_perturbSimJointPrimitiveState ; delegate ->
mPerturbFlexibleBodyState =
RobotArm_MoPhong_3ef711a9_1_perturbFlexibleBodyState ; delegate ->
...
RobotArm_MoPhong_3ef711a9_1_constructStateVector ; delegate ->
mExtractSolverStateVector =
RobotArm_MoPhong_3ef711a9_1_extractSolverStateVector ; delegate ->
mIsPositionViolation = RobotArm_MoPhong_3ef711a9_1_isPositionViolation ;
delegate -> mIsVelocityViolation =
RobotArm_MoPhong_3ef711a9_1_isVelocityViolation ; delegate ->
mProjectStateSim = RobotArm_MoPhong_3ef711a9_1_projectStateSim ; delegate ->
mComputeConstraintError = RobotArm_MoPhong_3ef711a9_1_computeConstraintError
; delegate -> mResetModeVector = RobotArm_MoPhong_3ef711a9_1_resetModeVector
; delegate -> mHasJointDisToNormModeChange =
RobotArm_MoPhong_3ef711a9_1_hasJointDisToNormModeChange ; delegate ->
mPerformJointDisToNormModeChange =
RobotArm_MoPhong_3ef711a9_1_performJointDisToNormModeChange ; delegate ->
mOnModeChangedCutJoints = RobotArm_MoPhong_3ef711a9_1_onModeChangedCutJoints
; delegate -> mMech = NULL ; } static void initMechanismDelegates (
NeDaePrivateData * smData ) { PmAllocator * alloc = pm_default_allocator ( )
; const int32_T motionInputOffsets [ 3 ] = { 2 , 1 , 0 } ; int_T status = 0 ;
...
} void RobotArm_MoPhong_3ef711a9_1_NeDaePrivateData_create ( NeDaePrivateData
