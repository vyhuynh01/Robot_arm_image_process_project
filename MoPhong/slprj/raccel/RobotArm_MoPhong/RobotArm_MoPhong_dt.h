...
DataTypeTransition rtBTransitions [ ] = { { ( char_T * ) ( & rtB . gc2rwfhdpe
[ 0 ] ) , 0 , 0 , 15 } , { ( char_T * ) ( & rtDW . mmepq1csxt [ 0 ] ) , 0 , 0
, 7 } , { ( char_T * ) ( & rtDW . bbbu1uieh0 ) , 11 , 0 , 8 } , { ( char_T *
) ( & rtDW . kdh5qwt13s ) , 10 , 0 , 1 } , { ( char_T * ) ( & rtDW .
pwf53itzjd ) , 8 , 0 , 1 } } ; static DataTypeTransitionTable rtBTransTable =
{ 5U , rtBTransitions } ; static DataTypeTransition rtPTransitions [ ] = { {
( char_T * ) ( & rtP . SliderGain1_gain ) , 0 , 0 , 9 } } ; static
